  ...
  */
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    if (chainId !== 80001) {
      ...
      throw new Error("Change netwoek to Mumbai");
    }
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            It's morts lottery game where a winner is chosen at random and wins the entire lottery pool
          </div>
          {renderButton()}
          {logs && 
            logs.map((log, index) => (
